...
- Sesión (portal cautivo): verificado `/etc/pf.conf` y `local.captive.pf.plist` en `/Library/LaunchDaemons`; PF aparece activo. Pendiente endurecer reglas con `block ... quick` y sin Internet Sharing/NAT para que clientes solo hablen con 192.168.2.1.
